	...
	var smoke = {
	  ...
	  i: 0,
		...
		finishbuild: function(e, f, box) {
			...
			if(f.params.transbase){
				var bg = document.getElementById('smoke-out-'+f.newid);
					bg.className += " smoke-base-trans";
			}
		...
		finishbuildSignal: function (e, f, box) {
			...
			smoke.smoketimeout[f.newid] = setTimeout(function () {
				smoke.destroy(f.type, f.newid);
				if (typeof f.callback !== 'undefined'&& typeof f.callback === 'object') {
					f.callback();
				}
			}, f.timeout);
		},
